...
class TestVector(TestCase):
    ...
    def test_parallel_to(self):
        ...
        self.assertEquals([round(x, 3) for x in v.component_parallel_to(basis).coordinates],
                         [1.083, 2.672])
    ...
    def test_orthogonal_component(self):
        ...
        self.assertEquals([round(x, 3) for x in v.component_orthogonal_to(basis).coordinates],
                         [-8.35, 3.376, -1.434])
